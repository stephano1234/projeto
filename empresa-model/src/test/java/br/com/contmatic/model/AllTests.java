...
@SuiteClasses({ AgenciaTest.class, ContaTest.class, TipoContaTest.class, CelularTest.class, TelefoneFixoTest.class,
		EmailTest.class, CidadeTest.class, BairroTest.class, LogradouroTest.class,
		EnderecoTest.class, TipoUfTest.class, PessoaTest.class, TipoGrauInstrucaoTest.class,
